...
public class ControlesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnTexto = (Button) view.findViewById(R.id.button10Texto);

        btnColor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //cuando pulteo btn color del fragment
        ...
        btnTexto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //cuando pulteo btn texto del fragment
                mListener.botonTextoClicked("HOLA YO");
            }
        });
        return  view;
    }
